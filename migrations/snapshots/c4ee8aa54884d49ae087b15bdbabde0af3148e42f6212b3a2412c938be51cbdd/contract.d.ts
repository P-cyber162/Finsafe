...
export type StorageHash =
  StorageHashBase<'c4ee8aa54884d49ae087b15bdbabde0af3148e42f6212b3a2412c938be51cbdd'>;
export type ExecutionHash =
  ExecutionHashBase<'8b132c38985148ad0fdb188c9299e0e26e3d6b8f37a23caeff3a9aaf3006e57c'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly refreshTokenExpires: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
  };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly refreshTokenExpires: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
  };
...
export namespace Models {
  export type public_User = {
    ...
    refreshTokenExpires: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
        ...
        readonly entries: {
          readonly table: {
            readonly Payments: {
              ...
              uniques: readonly [{ readonly columns: readonly ['email', 'key'] }];
              indexes: readonly [];
          ...
          readonly valueSet: {
            readonly Currency: {
              ...
              readonly values: readonly ['GHS', 'USD', 'GBP'];
            };
          };
        };
      };
          ...
          readonly User: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly refreshTokenExpires: { readonly column: 'refreshTokenExpires' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
        ...
        readonly enum: {
          readonly Currency: {
            ...
            readonly members: readonly [
              { readonly name: 'GHS'; readonly value: 'GHS' },
